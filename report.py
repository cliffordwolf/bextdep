...
def gates(core_id, add_grev=False):
    gates_core, delay = gatecount(core_id)
    gates_core_grev = gates_core + (gatecount("%sgo" % core_id[0:2])[0] if add_grev else 0)
    gates_ref = gatecount("%salu" % core_id[0:2])[0]
    return (gates_core, gates_core / gates_ref, gates_core_grev / gates_ref, delay)
...
print()
print("| Name          |  Gates |    Rel |  Rel+G | Delay | Description                               |")
print("|:------------- | ------:| ------:| ------:|------:|:----------------------------------------- |")
print("| `bextdep64g3` |  %5d |  %5.2f |  %5.2f | %5d | 3-stage pipeline with GREV                |" % gates("64g3"))
print("| `bextdep64p3` |  %5d |  %5.2f |  %5.2f | %5d | 3-stage pipeline                          |" % gates("64p3", True))
print("| `bextdep64g2` |  %5d |  %5.2f |  %5.2f | %5d | 2-stage pipeline with GREV                |" % gates("64g2"))
print("| `bextdep64p2` |  %5d |  %5.2f |  %5.2f | %5d | 2-stage pipeline                          |" % gates("64p2", True))
print("| `bextdep64g1` |  %5d |  %5.2f |  %5.2f | %5d | single-stage with GREV support            |" % gates("64g1"))
print("| `bextdep64p1` |  %5d |  %5.2f |  %5.2f | %5d | single-stage implementation               |" % gates("64p1", True))
print("| `bextdep64sh` |  %5d |  %5.2f |  %5.2f | %5d | 4-cycles sequential implementation        |" % gates("64sh", True))
print("| `bextdep64sb` |  %5d |  %5.2f |  %5.2f | %5d | 8-cycles sequential implementation        |" % gates("64sb", True))
print("| `bextdep64sn` |  %5d |  %5.2f |  %5.2f | %5d | 16-cycles sequential implementation       |" % gates("64sn", True))
print("| `bextdep64sx` |  %5d |  %5.2f |  %5.2f | %5d | up-to-64-cycles sequential implementation |" % gates("64sx", True))
print("| `bextdep64go` |  %5d |  %5.2f |  %5.2f | %5d | single-stage GREV-only core               |" % gates("64go"))
print("| `vscalealu64` |  %5d |  %5.2f |  %5.2f | %5d | ALU from V-Scale CPU (for comparison)     |" % gates("64alu", True))
print()
print("| Name          |  Gates |    Rel |  Rel+G | Delay | Description                               |")
print("|:------------- | ------:| ------:| ------:|------:|:----------------------------------------- |")
print("| `bextdep32g3` |  %5d |  %5.2f |  %5.2f | %5d | 3-stage pipeline with GREV                |" % gates("32g3"))
print("| `bextdep32p3` |  %5d |  %5.2f |  %5.2f | %5d | 3-stage pipeline                          |" % gates("32p3", True))
print("| `bextdep32g2` |  %5d |  %5.2f |  %5.2f | %5d | 2-stage pipeline with GREV                |" % gates("32g2"))
print("| `bextdep32p2` |  %5d |  %5.2f |  %5.2f | %5d | 2-stage pipeline                          |" % gates("32p2", True))
print("| `bextdep32g1` |  %5d |  %5.2f |  %5.2f | %5d | single-stage with GREV support            |" % gates("32g1"))
print("| `bextdep32p1` |  %5d |  %5.2f |  %5.2f | %5d | single-stage implementation               |" % gates("32p1", True))
print("| `bextdep32sb` |  %5d |  %5.2f |  %5.2f | %5d | 4-cycles sequential implementation        |" % gates("32sb", True))
print("| `bextdep32sn` |  %5d |  %5.2f |  %5.2f | %5d | 8-cycles sequential implementation        |" % gates("32sn", True))
print("| `bextdep32sx` |  %5d |  %5.2f |  %5.2f | %5d | up-to-32-cycles sequential implementation |" % gates("32sx", True))
print("| `bextdep32go` |  %5d |  %5.2f |  %5.2f | %5d | single-stage GREV-only core               |" % gates("32go"))
print("| `vscalealu32` |  %5d |  %5.2f |  %5.2f | %5d | ALU from V-Scale CPU (for comparison)     |" % gates("32alu", True))
print()
